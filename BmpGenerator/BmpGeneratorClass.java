...
public class BmpGeneratorClass {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BmpGeneratorClass myBmp = new BmpGeneratorClass();
        for (int i = 0 ;i<10;i++){
        myBmp.randomBmp(new Dimension(width,height),depth);
     ...
     * The bit depth should belong to  {1,4,8,16,24,32}
    ...
    private void randomBmp(Dimension d ,int bitDepth) {
        ...
        try{
            ...
            if (!output.exists())
                    output.mkdir();
            f = new File(output.getAbsolutePath()+"\\Bitmap_"+fileNumber+".bmp");
